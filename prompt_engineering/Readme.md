...
## Lab 4 — Tree-of-Thought Prompting (다중 사고 경로)
...
## Lab 5 — Meta Prompting (프롬프트 생성 AI)
...
### 실습용 예제 파일
- [1.개인정보 처리 및 제3자 제공 정책.txt](./rag/1.개인정보%20처리%20및%20제3자%20제공%20정책.txt)
- [2.직원용 개인정보 처리·공유 가이드라인.txt](./rag/2.직원용%20개인정보%20처리·공유%20가이드라인.txt)
- [3.개인정보 제3자 제공 관련 FAQ.txt](./rag/3.개인정보%20제3자%20제공%20관련%20FAQ.txt)
- [4.제3자 데이터 제공 요청서.txt](./rag/4.제3자%20데이터%20제공%20요청서.txt)
...
# 요약
- 본 랩은 Zero-shot, Few-shot, CoT, ToT, Meta Prompting, Prompt Chaining, RAG, Persona, Self-review 등 주요 프롬프트 기법을 실습을 통해 비교·평가하도록 설계되었습니다.
- 핵심 목표는 프롬프트 설계가 출력 품질에 미치는 영향을 이해하고, 실무 적용 가능한 검증·피드백 루프를 구축하는 것입니다.
